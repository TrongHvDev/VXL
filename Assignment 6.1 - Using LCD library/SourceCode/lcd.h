...
#define PORT_D4     LATBbits.LATB4
#define PORT_D5     LATBbits.LATB5
#define PORT_D6     LATBbits.LATB6
#define PORT_D7     LATBbits.LATB7

    
//#define LCD_PWR      PORTDbits.RC7                      // LCD power pin
#define LCD_EN       PORTCbits.RC2                     // LCD enable
#define LCD_RW       PORTCbits.RC1                      // LCD read/write line
#define LCD_RS       PORTCbits.RC0                      // LCD register select line
